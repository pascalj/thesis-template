...
You can also cite references like~\autocite{moore_cramming_1965}.

Just include them like seen in \cref{lst:import}.

\begin{codelisting}

\caption{Import example}

\hypertarget{lst:import}{%
\label{lst:import}}%
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{\textbackslash{}begin}\NormalTok{\{}\ExtensionTok{figure}\NormalTok{\}[h]}
  \BuiltInTok{\textbackslash{}includegraphics}\NormalTok{\{}\ExtensionTok{tmp/format/name}\NormalTok{\}}
  \FunctionTok{\textbackslash{}caption}\NormalTok{\{My label\}}
  \KeywordTok{\textbackslash{}label}\NormalTok{\{}\ExtensionTok{fig:lab}\NormalTok{\}}
